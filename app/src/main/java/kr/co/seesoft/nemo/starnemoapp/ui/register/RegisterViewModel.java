...
public class RegisterViewModel extends AndroidViewModel {
    ...
    private Handler apiMenuHandler;
    ...
    private boolean isDispMenu = false;
...
//                            sendCount.setValue(Integer.parseInt( result.getImgCnt() ));
    ...
    private void setDispMenu()
    {

//        AndroidUtil.log("isDisp ===> " + isDispMenu);

        try {
            List<NemoCustomerMemoCodeListRO> hList = codeMenuList.stream().filter(it -> {
                return it.getCmmnCd().equals("RESULT_SEARCH");
