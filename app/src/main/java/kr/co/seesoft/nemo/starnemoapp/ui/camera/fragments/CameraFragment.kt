...
import kr.co.seesoft.nemo.starnemoapp.ui.camera.KEY_EVENT_ACTION
import kr.co.seesoft.nemo.starnemoapp.ui.camera.KEY_EVENT_EXTRA
import kr.co.seesoft.nemo.starnemoapp.ui.camera.utils.ANIMATION_FAST_MILLIS
import kr.co.seesoft.nemo.starnemoapp.ui.camera.utils.ANIMATION_SLOW_MILLIS
import kr.co.seesoft.nemo.starnemoapp.ui.camera.utils.simulateClick
import kr.co.seesoft.nemo.starnemoapp.ui.dialog.CustomPhotoThumDialog
...
class CameraFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val callback = requireActivity().onBackPressedDispatcher.addCallback(this) {
            AndroidUtil.log("isSave : " + isSave)
            if( isSave )
                AndroidUtil.toast(context,"사진을 저장 중 입니다. 잠시후 다시 시도하세요.")
            else
